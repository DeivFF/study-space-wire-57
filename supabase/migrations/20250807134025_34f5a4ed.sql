-- Fix security warnings - Drop triggers first, then recreate functions with proper security settings
DROP TRIGGER IF EXISTS add_trail_admin_as_member_trigger ON public.study_trails;
