...
export const studyValidationSchemas = {
  ...
  createExercise: Joi.object({
    ...
    question_type: Joi.string().valid('multiple_choice', 'essay', 'true_false', 'fill_blank').default('multiple_choice'),
  ...
  updateExercise: Joi.object({
    ...
    question_type: Joi.string().valid('multiple_choice', 'essay', 'true_false', 'fill_blank'),
