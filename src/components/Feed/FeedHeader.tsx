...
import { mockNotificationSeeds, getNotificationsByFilter, getUnreadNotificationsCount, type MockNotification } from '@/lib/notification-seeds';
...
export function FeedHeader({
  ...
  const notificationsCount = getUnreadNotificationsCount(); // Use mock data count
