...
export default function StudyPost({ post, onLike, onComment, onReply }: StudyPostProps) {
  ...
  const formatContent = (content: string) => {
    // Converter quebras de linha em elementos <p>
  ...
  return (
    <div className="study-post-card">
      ...
      <div className="study-post-header">
        ...
        <div className="text-lg font-semibold">Postagem de Estudos</div>
      </div>
      ...
      <div className="study-post-content">
        ...
        <div className="study-author-section">
          ...
          <div className="study-author-meta">
            <div className="study-author-name">{post.author.name}</div>
            <div className="study-post-time">
              {post.time} • <span className="study-category-chip">{post.category}</span>
            </div>
          </div>
